...
Целью данных разработок которых создать удобные инструменты работы с платформой 1С как для разработчиков на языке 1С так и для администраторов информационных баз.
