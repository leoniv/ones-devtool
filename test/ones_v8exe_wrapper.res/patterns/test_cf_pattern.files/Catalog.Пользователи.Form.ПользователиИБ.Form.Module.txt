...
Процедура ПредставлениеОтбораНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПоказатьВыборИзСписка(
		Новый ОписаниеОповещения("ПредставлениеОтбораЗавершениеВыбора", ЭтотОбъект),
		Элемент.СписокВыбора,
		Элемент,
		Элемент.СписокВыбора.НайтиПоЗначению(Отбор));
	
КонецПроцедуры

&НаКлиенте
Процедура ПредставлениеОтбораЗавершениеВыбора(ВыбранныйЭлемент, Неопределен) Экспорт
	...
	Если ВыбранныйЭлемент <> Неопределено Тогда
		...
		ПредставлениеОтбораПриИзменении(Элементы.ПредставлениеОтбора);
	КонецЕсли;
...
Процедура ОткрытьПользователяПоСсылке()
	...
	Если ТекущиеДанные.КодПроблемы = 0 Тогда
		ПоказатьПредупреждение(
			Новый ОписаниеОповещения("УдалитьТекущегоПользователяИБ", ЭтотОбъект, Истина),
...
&НаКлиенте
Процедура УдалитьТекущегоПользователяИБ(УдалитьСтроку = Ложь) Экспорт
