...
//
//  СписокНовыхОбъектовМетаданных - Строка (возвращаемое значение) - содержит полные имена
//                  объектов метаданных, которые добавлены или требуется добавить.
//
Процедура ВыполнитьОбновлениеДанных(ЕстьИзменения = Ложь, ЕстьУдаленные = Ложь, ТолькоПроверка = Ложь, ЕстьКритичныеИзменения = Ложь,
			ТребуетсяОбновитьКэш = Ложь, СписокНовыхОбъектовМетаданных = "") Экспорт
