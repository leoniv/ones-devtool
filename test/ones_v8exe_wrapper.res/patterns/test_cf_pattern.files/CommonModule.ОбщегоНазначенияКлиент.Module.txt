...
//                                      Результат               - Булево. Истина - подключено.
...
#Иначе
	...
	ОбщегоНазначенияКлиентСервер.СообщитьПользователю(Нстр("ru = 'Операция недоступна. Необходимо запустить программу в тонком клиенте на компьютере с ОС Windows.'"));
