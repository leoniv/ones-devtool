...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(Параметры.Пользователь) Тогда
		Если УправлениеДоступомСлужебный.УпрощенныйИнтерфейсНастройкиПравДоступа() Тогда
			ВызватьИсключение
				НСтр("ru = 'Отчет открывается только для конкретного пользователя.
				           |Команда открытия есть в форме настройки прав доступа.'");
		Иначе
			ВызватьИсключение
				НСтр("ru = 'Отчет открывается только для конкретного пользователя или группы пользователей.
				           |Команда открытия есть в форме настройки прав доступа.'");
		КонецЕсли;
	КонецЕсли;
